...
const path = {
  ...
  src: {
    ...
    js: 'src/assets/script/script.js',
    img: 'src/assets/style/**/*.{jpg,jpeg,png,svg}',
    svg: 'src/assets/style/**/*.svg',
    imgF: 'src/assets/style/**/*.{jpg,jpeg,png}',
  ...
  watch: {
    ...
    svg: 'src/svg/**/*.svg',
    img: 'src/**/*.*',
    imgF: 'src/**/*.{jpg,jpeg,png}',
  },
  clean: './dist',
  cleanIMG: './dist/assets',
};
